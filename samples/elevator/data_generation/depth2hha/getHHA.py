...
from depth2hha.utils.rgbd_util import *
from depth2hha.utils.getCameraParam import *

'''
must use 'COLOR_BGR2GRAY' here, or you will get a different gray-value with what MATLAB gets.
'''
def getImage(root='demo'):
    D = cv2.imread(os.path.join(root, 'depth/20190515_201521_000000.png'), cv2.COLOR_BGR2GRAY)/10000
    RD = cv2.imread(os.path.join(root, 'depth/20190515_201521_000000.png'), cv2.COLOR_BGR2GRAY)/10000
    return D, RD
...
if __name__ == "__main__":
    D, RD = getImage("./../Mask_RCNN/datasets/elevator/20190515_201521/out/")
