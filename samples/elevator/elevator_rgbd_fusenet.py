...
class ElevatorRGBDFusenetDataset(utils.Dataset):
    """Generates the elevator dataset.
    """

    def __init__(self, class_map=None):
        self.class_name_to_id = {}
        super(ElevatorRGBDFusenetDataset, self).__init__(class_map)

    def add_class(self, source, class_id, class_name):
        self.class_name_to_id[class_name] = class_id
        super(ElevatorRGBDFusenetDataset, self).add_class(source=source, class_id=class_id, class_name=class_name)

    def load_elevator_rgbd_fusenet(self, dataset_dir, subset):
        ...
        self.add_class("elevator_rgbd_fusenet", 1, "human_standing")
        self.add_class("elevator_rgbd_fusenet", 2, "human_sitting")
        self.add_class("elevator_rgbd_fusenet", 3, "human_lying")
        self.add_class("elevator_rgbd_fusenet", 4, "bag")
        self.add_class("elevator_rgbd_fusenet", 5, "box")
        self.add_class("elevator_rgbd_fusenet", 6, "crate")
        self.add_class("elevator_rgbd_fusenet", 7, "plant")
        self.add_class("elevator_rgbd_fusenet", 8, "chair")
        self.add_class("elevator_rgbd_fusenet", 9, "object")
        self.add_class("elevator_rgbd_fusenet", 10, "human_other")
    ...
    def image_reference(self, image_id):
        ...
        if info["source"] == "elevator_rgbd_fusenet":
            return info["path"]
        else:
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "elevator_rgbd_fusenet":
