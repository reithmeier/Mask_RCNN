...
class SunRGBDParallelDataset(utils.Dataset):
    """Generates the sun rgbd dataset.
    """

    def load_sun_rgbd_parallel(self, dataset_dir, subset):
        ...
        self.add_class("sunrgbd_parallel", 1, "bed")
        self.add_class("sunrgbd_parallel", 2, "books")
        self.add_class("sunrgbd_parallel", 3, "ceiling")
        self.add_class("sunrgbd_parallel", 4, "chair")
        self.add_class("sunrgbd_parallel", 5, "floor")
        self.add_class("sunrgbd_parallel", 6, "furniture")
        self.add_class("sunrgbd_parallel", 7, "objects")
        self.add_class("sunrgbd_parallel", 8, "picture")
        self.add_class("sunrgbd_parallel", 9, "sofa")
        self.add_class("sunrgbd_parallel", 10, "table")
        self.add_class("sunrgbd_parallel", 11, "tv")
        self.add_class("sunrgbd_parallel", 12, "wall")
        self.add_class("sunrgbd_parallel", 13, "window")
    ...
    def image_reference(self, image_id):
        ...
        if info["source"] == "sunrgbd_parallel":
            return info["path"]
        else:
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "sunrgbd_parallel":
