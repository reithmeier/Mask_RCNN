...
NUM_FILTERS_S = "[32, 32, 64, 128, 256]"
NUM_FILTERS_M = "[64, 64, 128, 256, 512]"
NUM_FILTERS_L = "[128, 128, 256, 512, 1024]"

# hyper parameters
HP_NUM_FILTERS = tbhp.HParam('num_filters', tbhp.Discrete([NUM_FILTERS_S, NUM_FILTERS_M, NUM_FILTERS_L]))
...
space = OrderedDict([
    ('num_filters',
     hp.choice('num_filters', [NUM_FILTERS_S, NUM_FILTERS_M, NUM_FILTERS_L])),
...
with tf.summary.create_file_writer('logs/hparam_tuning_sunrgbd_fusenet').as_default():
    tbhp.hparams_config(
        hparams=[HP_NUM_FILTERS, HP_DETECTION_MIN_CONFIDENCE, HP_TRAIN_ROIS_PER_IMAGE, HP_OPTIMIZER],
...
class TPESearch:
    ...
    def objective(self, params):
        hparams = {
            'HP_NUM_FILTERS': params['num_filters'],
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model_dir", type=str, help="Directory to store weights and results",
                        default=ROOT_DIR + "/logs/hparam_tuning_sunrgbd_fusenet/")
